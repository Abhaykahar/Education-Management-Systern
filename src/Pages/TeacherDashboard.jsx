    ...
    <div className="container my-4">
      ...
      <section className="mb-6">
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12 border border-dark p-4 mb-3">
            <form className="mb-4">
          <div className="form-group">
            ...
            <button 
              ...
              className="btn btn-dark mt-4 mx-auto d-block"
            >
              Add Assignment
            </button>
          </div>
      ...
      <section>
        ...
        {courses.map(course => (
          <div key={course.id} className="mb-4 border border-dark rounded p-3">
            <h3 className="h5">{course.title}</h3>
            <ul className="list-unstyled">
              {course.assignments.length > 0 ? (
                course.assignments.map((assignment, index) => (
                  <li key={index} className="mb-2">
                    <span className="font-weight-bold">{assignment.title}</span> - Due: {assignment.dueDate}
                  </li>
                ))
              ) : (
